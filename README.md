...
- 정리하다 보니 프리랜서 개발자로 입문하시는 분께 좋은 내용이 되는 것 같네요. 시간이 되면 자료 정리를 계속 해볼 생각입니다.

<img width="300" src="/Images/seminarImage00.png"></img>
...
- 국내에선 아직 프리랜서 개발자에 대해 명확한 정의가 없습니다.  
- 세법에는 인적용역 사업자
	- 부가가치세법 시행령 42조 : 부가가치세법 상 프리랜서 중에서도 작가, 배우, 강사, 프로그래머 등 물적 시설 없이 근로자를 고용하지 아니하고 독립된 자격으로 용역을 공급하고 대가를 받는 사업자를 인적용역 사업자라 합니다.
	- [참조한 블로그](https://jascpa.tistory.com/70)
...
- 장점
	- 자유
		- 자유롭다는 것, 유연하게 일하는 것 참 좋아요.
	- 돈
		- 당연히 좋쵸.
	- 장기간 휴식가능
		- 만약 계약이 끝나고 쉬려고 마음먹는 다면 길게 쉴 수 있다는 게 참 달콤하네요.
	- 업무에 집중, 다양한 경험, 주말출근/야근이 적을 수 있음.
- 단점
	- 고용 불투명
	- 근무 중 휴가사용 힘듬 😭
	- 부정적 이미지
  		- 경력이 오래되신 정규직 분들일 수록 프리랜서 분들과 부정적 경험을 하신 적이 생기시는 것 같습니다.
	- 계약서 작성, 평일세미나 참석힘듬, 퇴직금 없음, 4대보험은 직접, 쉬는 만큼 돈벌지 못함, 부정적 이미지, 처우 나쁨

## 개인 이력 카드 양식
- [개인 이력 카드 양식](https://github.com/ClintJang/awesome-freelance-korea-information/blob/master/Docs/freelance-personal-history-card-form-ko.doc) 
	- 정규직 구직할 때와 달리 간략한 이력 카드만을 요구합니다.
	- 경력기술서 혹은 개인이력카드 라고 합니다. 
	- 그리고 포트폴리오 주세요? 라고 하는 것은 양식 안에 Skill Inventory 부분입니다. 한번에 그동안 개발해왔던 부분을 간략하게 볼 수 있지요. 그것을 포트폴리오라고 합니다.
...
## 계약급여
- 계약급여는 작성하기 부담스러우니 여기서 적기 애매하네요. 발표내용을 나중에 확인해주세요.😀
- 아니면 언제든 편하게 저에게 물어봐 주세요. 😀😀
- 그리고 [okky 잡 검색링크](https://okky.kr/articles/jobs) 에서 글들을 보시면, 어떤 글들에 고급, 중급, 초급 단가들이 적혀있습니다. 그 정도 어간이라고 생각하시면 됩니다.
...
- 그리고 5월 종합소득세 신고를 통해 연말정산을 하시면 됩니다.
	...
	- 중도퇴직자
- 5월 종합소득세 신고를 통해 세금 3.3%에 대해 환급을 받으실 수 도 있습니다. (반대도..)
...
## 계약서
### 주의사항
> 계약서를 사전에 검토를 하기만 해도 매우 불리한 계약서 작성을 하지 않게 될 수 있습니다. <br />
처음에는 부족한 검토 실력이라도 사약서 사본을 먼저 받아서 계약기간, 계약급여, 급여 일자, 독소 조항을 확인하고 <br />
필요하다면 특기/특약사항을 요청하고, 붙임문서가 필요하면(예)월별지급내역서 등등) 을 요청하고 마지막으로 계약서 우선순위나 효력을 위해 계약일자를 확인하는 습관을 가지셨으면 좋겠습니다.
...
### 계약서 셈플 링크
- [제가 작성해본 계약서 참고용 셈플 3가지](https://github.com/ClintJang/awesome-freelance-korea-information/blob/master/freelance-contract-template.md)
...
- 단말기유통구조 개선법(단통법)
	- 단말기 출고가와 판매가가 상이하여 생기는 혼란을 없애자는 취지로 번호이동,신규가입,기기변경 등 가입 조건에 상관없이 보조금이 통일됩니다.
	- 단통법은 단말기유통법으로 2014년 4월 30일 국회에서 통과
	- 단통법 시행일은 2014년 10월 1일부터 시행

	```
	시장조사기관 아틀라스리서치컨설팅에 따르면 2014년 10월 말 
	아이폰6가 출시되자 애플의 점유율은 
	10월 6.6%에서 11월 34.2%까지 치솟았다. 
	같은 기간 삼성전자는 68.3%에서 47.7%로, 
	LG전자는 22.1%에서 11.5%로 각각 급감했다
	```
...
- [단통법 시행일 정리해봤어요](http://blog.naver.com/PostView.nhn?blogId=golabhs&logNo=220135976796)

### 그 외
당연한 이야기이지만 좋은 개발자를 구하기 참 어려워 하시는 것 같습니다.
정보를 얻게 되면 계속 업데이트 해보겠습니다.
...
- 국외
	- [Upwork](https://www.upwork.com/) : 글로벌 프리랜서 사이트, Get matched to top talent in minutes through our global network of skilled freelancers and professional agencies.
...
- Q. 공실없이 일 구하는 방법은 무엇일까요?
	...
	- iOS, android, C#, java, C, C++, .net .. 등등 분야에 따라 수요가 달라서, 상황은 다릅니다.
	- 어느 정도 나이가 많아지면 😭 공실률이 높아지는 것 같습니다.
...
- Q. 좋은 프로젝트, 일감고르는 법은 어떤 방법이 있을 까요?
	- 쉽지 않습니다. 인터뷰 시에 최대한 질문을 해서 구별해 봐야됩니다.
	- 그 외에 프로젝트 규모가 크고 자금의 여유가 있는 프로젝트에서는 좀 더 좋은 프로젝트일 확률이 높습니다.
- Q. 업무 외 장비같은 지원범위는 어떻게 될까요?
	- 지급되는 프로젝트도 있고, 지급되지 않는 프로젝트도 있습니다.
	- 장비가 맥이라서 지급되지 않는 프로젝트가 더 많습니다.
	- 금융권은 보안 때문에 맥장비가 지급되는 곳이 더 많을 수 있습니다.
- Q. 중급 인대 초급 급여 줄라고 할때 대처법은 어떻게 될까요?
	- 요즘 개발자가 귀한 시기 입니다. 다른 프로젝트를 알아보세요.
- Q. 개인 사업자 등록 꼭 해야됩니까?
	- 아니요. 안해도 됩니다.
	- 인적용역 사업자의 경우는 부가세법상 면세사업자이며 사업자 미등록 가산세가 없기 때문에 사업자 등록을 안해도 괜찮습니다.
	- 다만, 물건을 팔거나 서비스를 지속하는 .. 취미에서 벗어나는 서비스를 제공한다면 사업자 등록이 필요합니다.
	- 연매출이 7,500만원이 초과되면 사업자 등록을 추천합니다. 복식부기 장부 작성 대상자가 되서 사업자 등록이 편한 경우가 있습니다.
	- 상담은? 세무회계사무소에 ^^;;;
- Q. Clint는 프리랜서 개발자를 추천하시나요?
	- 제가 개인적으로 프리랜서 개발자를 추천 드리는 분은 3가지 느낌을 저에게 주시는 분 들입니다.
	
	```
	첫째로 비니스적인 마인드를 가지신 분들..
	둘째로 회사가 너무 힘들어서 개발자를 그만둘까? 하는 분 들이라면 ..
	셋째로 둘째의 반대인데 강한 맨탈, 자기 의지를 가지신 분들은 
	개인적으로는 추천드립니다. 
	```
