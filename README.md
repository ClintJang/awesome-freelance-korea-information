...
- 국내
	...
	- [프리모아](http://m.freemoa.net/) : 안전한 IT 전문가 중개 플랫폼
...
- Q. 잡코리아랑 사람인에다 이력서 오픈하면 프리 관련 연락은 잘 안오나요? 경력이 1년 5개월 정도로 애매한 상태인데... 연락이 올지 좀 걱정이 됩니다.
	- 개인적으로 년차가 안되실 때는 프리랜서를 비추합니다.. 소화안되면 배탈이나고 스트레스 받을 수 있으니깐요..
	- 연락은 올 거라 생각됩니다만.. 개발하실 수 있는 언어에 따라 좀 다를 것 같네요.
	- 초급은 많치 않을거에요. 잡코리아 이력서를 해드헌터만 오픈하는 식으로 오픈해 보세요. 전화가 걸려오는 지~ … 대부분 중급 이상이에요.
	- [OKKY Job](https://okky.kr/articles/jobs)에서 나오는 업체들에 메일주소나 전화번호가 있다면 조금 더 적극적으로 연락을 해봐도 괜찮을 거에요. "어떤(예:iOS) 분야 개발 몇년 개발했습니다. 혹시 해당 분야의 개발 자리가 있을까요? 참고로 저는 어느지역에 살아서 이쪽에 가까운 곳이면 좋겠습니다..." 등등.. 예의 있게?? :) .....
